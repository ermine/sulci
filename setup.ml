...
(* OASIS_START *)
(* DO NOT EDIT (digest: 01b7fdb9319a3f7ff7060f731fa2b3be) *)
(*
          ...
          distclean_custom =
            {
               ...
               post_command =
                 [
                    (OASISExpr.EBool true,
                      Some (("$rm", ["sulci.conf"; "version.ml.src"])))
                 ];
               };
          files_ab = ["version.ml.src.ab"; "sulci.conf.ab"];
          sections =
            [
               SrcRepo
                 ({
                     ...
                     },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage ("brainfuck", None);
                           FindlibPackage ("logger", None);
                           FindlibPackage ("dehtml", None);
                           FindlibPackage ("scheduler", None);
                           FindlibPackage ("strftime", None);
