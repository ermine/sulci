...
(* OASIS_START *)
(* DO NOT EDIT (digest: 9247d9964a0dc89bf15d7675d37b6117) *)
(*
...
let setup_t =
  {
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage ("erm_brainfuck", None);
                           FindlibPackage ("erm_logger", None);
                           FindlibPackage ("erm_dehtml", None);
                           FindlibPackage ("erm_scheduler", None);
                           FindlibPackage ("erm_strftime", None);
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "D\028\245a?$m\131bZ\148\204\142\130\159\210";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
