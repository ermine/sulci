...
(* OASIS_START *)
(* DO NOT EDIT (digest: 63f09cc72e3a675720e737113edfa9c4) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          files_ab = ["src/version.ml.src.ab"; "sulci.conf.example.ab"];
          sections =
            [
               Executable
                 ({
     ...
     oasis_version = "0.4.5";
     oasis_digest =
       Some "i\248\023\214\214\221\155\203\0270\179\131\rk\"\245";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
