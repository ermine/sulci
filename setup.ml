...
(* OASIS_START *)
(* DO NOT EDIT (digest: 1a38308e60197d1a5403548c4cb74106) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          files_ab = ["version.ml.ab"; "sulci.conf.ab"];
          sections =
            [
               Executable
                 ({
               ...
               Executable
                 ({
                     ...
                     },
                   {
                      ...
                      bs_data_files =
                        [
                           ("_build/tlds/tlds.db ($datadir/$pkg_name)/tlds",
                             None);
                           ("_build/lang/*.htbl",
                             Some "$datadir/$pkg_name/lang");
                           ("sulci.conf", Some "$sysconfdir")
                        ];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
                      bs_cclib = [(OASISExpr.EBool true, [])];
                      bs_dlllib = [(OASISExpr.EBool true, [])];
     ...
     oasis_version = "0.3.1";
     oasis_digest = Some "\031MÌÃ4á§÷ùqrÃZú\014∑";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
