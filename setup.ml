...
(* OASIS_START *)
(* DO NOT EDIT (digest: e04fb5bd2edc980afccc8e085decd4de) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          files_ab = ["src/version.ml.ab"; "sulci.conf.example.ab"];
          sections =
            [
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "langcompile.ml"});
               Executable
                 ({
                     cs_name = "createtld";
                     cs_data = PropList.Data.create ();
                  ...
                  },
                   {
                      ...
                      bs_path = "tlds/";
                      bs_compiled_object = Best;
                      bs_build_depends = [FindlibPackage ("dbm", None)];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
                   ...
                   {exec_custom = false; exec_main_is = "createtlds.ml"});
               Library
                 ({
                     cs_name = "brainfuck";
                     cs_data = PropList.Data.create ();
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Heapqueue"; "Scheduler"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = None;
               ...
               Library
                 ({
                   ...
                   },
                   {
                      lib_modules = ["Dehtml"];
                      lib_pack = false;
                      lib_internal_modules = ["Rlex1"; "Rlex2"];
                      lib_findlib_parent = None;
                      lib_findlib_name = None;
                      lib_findlib_containers = []
                   });
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           InternalLibrary "brainfuck";
                           InternalLibrary "logger";
                           InternalLibrary "dehtml";
                           InternalLibrary "scheduler";
                           InternalLibrary "strftime";
                           FindlibPackage ("erm_xml", None);
                           FindlibPackage
                             ("erm_xmpp",
                               Some (OASISVersion.VGreaterEqual "0.4"));
                           ...
                           FindlibPackage
                             ("netclient",
                               Some (OASISVersion.VGreaterEqual "4.0.1"));
                           FindlibPackage ("dbm", None);
                           FindlibPackage ("json-static", None);
                           InternalLibrary "treap"
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files =
                        [
                           ("_build/tlds/tlds.db",
                             Some "$datadir/$pkg_name/tlds");
                           ("_build/lang/*.htbl",
                             Some "$datadir/$pkg_name/lang");
                           ("sulci.conf.example", Some "$sysconfdir")
                        ];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
                      bs_cclib = [(OASISExpr.EBool true, [])];
                      bs_dlllib = [(OASISExpr.EBool true, [])];
                   ...
                   {exec_custom = false; exec_main_is = "sulci.ml"});
               SrcRepo
                 ({
                     cs_name = "github";
                     cs_data = PropList.Data.create ();
                   ...
                   {
                      src_repo_type = Git;
                      src_repo_location = "git://github.com/ermine/sulci.git";
                      src_repo_browser =
                        Some "https://github.com/ermine/sulci";
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\150\2243{\1579\195\136\165\145?\127\238\141[\231";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
